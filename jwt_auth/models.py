...
class User(AbstractUser):
    ...
    profile_pic = models.CharField(
        max_length=250, null=True, default='https://res.cloudinary.com/dnvstdsde/image/upload/v1623409738/user_yf5keh.png')
    ...
    background_pic = models.CharField(
        max_length=250, null=True, default='https://res.cloudinary.com/dnvstdsde/image/upload/v1623410114/index_s7iuv2.jpg')
